    ...
    <form method="POST" class="form-container">
        ...
        <script>
            ...
            nextBtn.addEventListener("click", (event) => {
                ...
                var encodedTotalsArr = encodeToBase64(JSON.stringify(totalsArr));
                var encodedLists = encodeToBase64(JSON.stringify(list));
                var url = "position.php?user-details=" + encodedUserDetails + "&year=" + year + "&award-val=" + encodedAwardVal + "&award-names=" + encodedAwardNames + "&researchVal=" + encodedResearchVal + "&researchNames=" + encodedResearchNames + "&researchNames1=" + encodedResearchNames1 + "&extensionVal=" + encodedTotalsArr + "&extensionNames=" + encodedLists;
